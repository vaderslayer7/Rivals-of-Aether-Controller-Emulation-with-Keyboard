...
coordsOrigin := [0, 0]
coordsVertical := [0, 1]
coordsVerticalModX := [0, 0.7]
coordsVerticalModY := [0, 0.7]
coordsHorizontal := [1, 0]
coordsHorizontalModX := [0.7, 0]
coordsHorizontalModY := [0.7, 0]
coordsQuadrant := [0.7, 0.7]
coordsQuadrantModX := [0.6578, 0.2394]
coordsQuadrantModY := [0.2394, 0.6578]
...
coordsAirdodgeQuadrant := [0.7, 0.7]
coordsAirdodgeQuadrant12 := [0.7, 0.7]
coordsAirdodgeQuadrant34 := [0.7, 0.7]
coordsAirdodgeQuadrantModX := [0.6578, 0.2394]
coordsAirdodgeQuadrant12ModY := [0.2394, 0.6578]
coordsAirdodgeQuadrant34ModY := [0.2394, 0.6578]

coordsFirefoxModXCDown := [0.6062, 0.35]     ; ~27 deg
coordsFirefoxModXCLeft := [0.6062, 0.35]  ; ~32 deg
coordsFirefoxModXCUp := [0.6062, 0.35]       ; ~36 deg
coordsFirefoxModXCRight := [0.6062, 0.35]  ; ~41 deg
coordsFirefoxModYCRight := [0.35, 0.6062] ; ~50 deg
coordsFirefoxModYCUp := [0.35, 0.6062]       ; ~54 deg
coordsFirefoxModYCLeft := [0.35, 0.6062]  ; ~58 deg
coordsFirefoxModYCDown := [0.35, 0.6062]     ; ~63 deg

coordsExtendedFirefoxModX := [0.6578, 0.2394]       ; ~23 deg
coordsExtendedFirefoxModXCDown := [0.6062, 0.35]     ; ~27 deg
coordsExtendedFirefoxModXCLeft := [0.6062, 0.35]     ; ~32 deg
coordsExtendedFirefoxModXCUp := [0.6062, 0.35]    ; ~36 deg
coordsExtendedFirefoxModXCRight := [0.6062, 0.35] ; ~40 deg
coordsExtendedFirefoxModYCRight := [0.35, 0.6062] ; ~50 deg
coordsExtendedFirefoxModYCUp := [0.35, 0.6062]       ; ~54 deg
coordsExtendedFirefoxModYCLeft := [0.35, 0.6062]     ; ~58 deg
coordsExtendedFirefoxModYCDown := [0.35, 0.6062]     ; ~63 deg
coordsExtendedFirefoxModY := [0.2394, 0.6578]       ; ~67 deg
...
; Converts coordinates from melee values (-1 to 1) to vJoy values (0 to 32767). 10271
convertCoords(coords) {
  mx = 16000 ; Why this number? idk, I would have thought it should be 16384 * (80 / 128) = 10240, but this works
  my = -16000
  bx = 16448 ; 16384 + 64
  by = 16320 ; 16384 - 64
